...
class Program
{
    ...
    {
        Tabela.Tabela vinho = new Tabela.Tabela("CSVs/vinho.csv"); // cria estrutura necessária para a tabela
        Tabela.Tabela uva = new Tabela.Tabela("CSVs/uva.csv");
        Tabela.Tabela pais = new Tabela.Tabela("CSVs/pais.csv");

        Tabela.Tabela Customer = new Tabela.Tabela("CSVs/customer.csv"); // cria estrutura necessária para a tabela
        Tabela.Tabela Orders = new Tabela.Tabela("CSVs/orders.csv");
        ...
        Operador.Operador op = new Operador.Operador(vinho, uva, "vinho_id", "uva_id", "saida.csv");
